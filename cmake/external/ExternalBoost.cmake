...
IF(WIN32)
    ...
    set(BOOST_BOOTSTRAP_COMMAND ./bootstrap.bat msvc)
...
ExternalProject_Add(		Boost
        ...
        BUILD_COMMAND 		${BOOST_B2_COMMAND} install -q -j8 --prefix=${INSTALL_DEPENDENCIES_DIR}/libboost --enable-shared --enable-pic variant=release threading=multi ${BOOST_LIBRARIES_ADD} address-model=${BOOST_ADR_MODEL} link=${BUILD_LIBS} runtime-link=${BUILD_LIBS} ${BOOST_TOOLSET} ${BOOST_FLAGS}
        INSTALL_COMMAND 	""
