...
// * Smith normalform
// **********************************************************************************************************************/
//std::map<num::ap_int, unsigned int, num::comp::SIGNED_COMPARATOR> smith(stream<vec::s_ap_int_vec>&& matrix) {
//    return smith(std::forward<stream<vec::s_ap_int_vec>>(matrix));
//}
//
//std::map<num::ap_int, unsigned int, num::comp::SIGNED_COMPARATOR> smith(stream<vec::s_ap_int_vec>& matrix) {
